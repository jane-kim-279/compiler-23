/*
* 토큰 타입 정의 
* (Comment, Identifier, Constant, Keyword, Operator, Special symbol, Erorr)
*/
enum tnumber {
	TEOF,
	...
	//Identifier & Constant
	TIDENT, TEXIST, TDNUMBER, TONUMBER, THNUMBER,

	//Keyword - const, else, if, int, return, void, while
	TCONST, TELSE, TIF, TINT, TRETURN, TVOID, TWHILE, TD,
